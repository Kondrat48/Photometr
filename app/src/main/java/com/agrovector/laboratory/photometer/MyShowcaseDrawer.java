...
public class MyShowcaseDrawer implements ShowcaseDrawer {
    ...
    public MyShowcaseDrawer(Resources resources) {
        this.radius = resources.getDimension(R.dimen.showcase_radius_material)*2;
